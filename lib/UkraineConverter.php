<?php
class UkraineConverter extends Converter{
    protected $_language    = "Ukraine";

    protected $_conjunction = ' ';
    protected $_separator   = ' ';
    protected $_hyphen      = ' ';
    protected $_negative    = 'мінус ';
    ...
    protected function moreThen1000($number, $_text)
    {
        ...
        if($baseUnit == 1000 && $numBaseUnits == 2){
            $_text = 'дві' . ' ' . $this->_thousand[$this->changeEnding($numBaseUnits)];
